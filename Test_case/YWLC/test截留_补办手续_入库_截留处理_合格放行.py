...
class xdwcy_TestCase(xdw_TestCase,cycl_TestCase):
    ...
    def test04_截留物处理_合格放行(self):
        ...
        Select(self.dr.find_element_by_xpath('//*[@id="jlcljg"]')).select_by_visible_text('合格')
    ...
    def test06_出库记录查询(self):
        ...
        time.sleep(1)
        self.assertEqual(id,self.dr.find_element_by_xpath('//*[@id="list"]/tbody/tr/td[1]').text)
        self.assertEqual('放行',self.dr.find_element_by_xpath('//*[@id="list"]/tbody/tr/td[6]').text)
