...
class xdwcy_TestCase(xdw_TestCase,cycl_TestCase):
    ...
    def test02_实验室检疫_截留物处理查询(self):
        self.Initialization_1()
        self.dr.find_element_by_xpath('//*[@id="dc80e8e80a55480c82aeae8370b31b1a"]').click()
    ...
    def test03_实验室检疫_入库(self):
        self.Initialization_1()
        self.dr.find_element_by_xpath('//*[@id="dc80e8e80a55480c82aeae8370b31b1a"]').click()
        self.dr.find_element_by_xpath('//*[@id="f683e4f46b094a8ba68ad201a6e5b7bf"]').click()
    ...
    def test05_实验室检疫_出库(self):
        ...
        self.dr.find_element_by_xpath('//*[@id="6c25cddc87d7418fb9825b762737a2c0"]').click()
    ...
    def test08_截留物处理_不合格移交保护部门(self):
        self.Initialization_1()
        self.dr.find_element_by_xpath('//*[@id="dc80e8e80a55480c82aeae8370b31b1a"]').click()
        self.dr.find_element_by_xpath('//*[@id="88f0f33abf2d48419438a72637c27b49"]').click()
        iframe=self.dr.find_element_by_xpath('//*[@id="sub_88f0f33abf2d48419438a72637c27b49"]/iframe')
        ...
        self.xdw_Other_Interception_Processing_Handle({'jlcljg': '不合格', 'jlwpjg': '移交保护部门'})

    def test09_实验室检疫_不合格移交保护部门出库(self):
        self.Initialization_1()
        self.dr.find_element_by_xpath('//*[@id="436c1edb6d364195beb2ca044dceb58f"]').click()
        self.dr.find_element_by_xpath('//*[@id="6c25cddc87d7418fb9825b762737a2c0"]').click()
    ...
    def test10_实验室检疫_不合格移交保护部门_出库记录查询(self):
        self.Initialization_1()
        self.dr.find_element_by_xpath('//*[@id="dcefdfba1ea04e2db15876bd8673651d"]').click()
        ...
        time.sleep(1)
        self.assertEqual(id,self.dr.find_element_by_xpath('//*[@id="list"]/tbody/tr/td[1]').text)
        self.assertEqual('移交保护部门',self.dr.find_element_by_xpath('//*[@id="list"]/tbody/tr/td[6]').text)

    def test11_实验室检疫_移交保护部门出库单据查询(self):
        self.Initialization_1()
        self.dr.find_element_by_xpath('//*[@id="dcefdfba1ea04e2db15876bd8673651d"]').click()
        self.dr.find_element_by_xpath('//*[@id="758f1d8d5cb34a5f9873e07ce5c5fb59"]').click()
        ...
        time.sleep(2)
        self.assertEqual(id,self.dr.find_element_by_xpath('//*[@id="list"]/tbody/tr/td[2]').text)
        self.assertEqual('移交保护部门',self.dr.find_element_by_xpath('//*[@id="list"]/tbody/tr/td[8]').text)
